...
{
    [TestFixture]
    public class WhenIBulkPublishDeletionEvents : ApprenticeshipEventsTestsBase
    {
        ...
        public async Task ThenTheEventsArePublished()
        {
            ...
            await Service.BulkPublishDeletionEvent(Commitment, apprenticeships, _event);
        ...
        {
            CommitmentsLogger.Verify(x => x.Info("Creating apprenticeship events", null, null, null, null), Times.Once);
