...
namespace SFA.DAS.Commitments.Application.UnitTests.Commands.RejectApprenticeshipChange
{
    ...
    public class WhenRejectingApprenticeshipChange
    {
        ...
        public async Task ThenTheApprenticeshipWillBeUpdatedIfRejected()
        {
            ...
            _repository.Verify(m => m.ApproveApprenticeshipUpdate(It.Is<ApprenticeshipUpdate>(u => u.Id == 42), It.IsAny<Apprenticeship>(), It.IsAny<Caller>()), Times.Never);
            _repository.Verify(m => m.RejectApprenticeshipUpdate(It.Is<ApprenticeshipUpdate>(u => u.Id == 42)), Times.Once);
