...
namespace SFA.DAS.Commitments.Application.UnitTests.Commands.UpdateApprenticeship
{
    ...
    public sealed class WhenUpdatingApprenticeship
    {
        ...
        public void SetUp()
        {
            ...
            _handler = new UpdateApprenticeshipCommandHandler(_mockCommitmentRespository.Object, new UpdateApprenticeshipValidator(), new ApprenticeshipUpdateRules(), _mockApprenticeshipEvents.Object);
