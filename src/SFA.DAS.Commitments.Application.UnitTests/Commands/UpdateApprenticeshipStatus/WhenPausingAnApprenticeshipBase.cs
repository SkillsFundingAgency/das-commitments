...
{
    public class WhenPausingAnApprenticeshipBase
    {
        protected PauseApprenticeshipCommand ExampleValidRequest;
        protected PauseApprenticeshipCommandHandler Handler;
