...
{
    public class EmployerCommitmentApi : IEmployerCommitmentApi
    {
        ...
        {
            var url = $"{BaseUrl}api/employer/{employerAccountId}/commitments";
        ...
        {
            var url = $"{BaseUrl}api/employer/{employerAccountId}/commitments/{commitmentId}";
        ...
        {
            var url = $"{BaseUrl}api/employer/{employerAccountId}/apprenticeships/";
        ...
        {
            var url = $"{BaseUrl}api/employer/{employerAccountId}/apprenticeships/{apprenticeshipId}";
        ...
        {
            var url = $"{BaseUrl}api/employer/{employerAccountId}/commitments/{commitmentId}/apprenticeships";
        ...
        {
            var url = $"{BaseUrl}api/employer/{employerAccountId}/commitments/{commitmentId}/apprenticeships/{apprenticeshipId}";
        ...
        {
            var url = $"{BaseUrl}api/employer/{employerAccountId}/apprenticeships/{apprenticeshipId}/update";
