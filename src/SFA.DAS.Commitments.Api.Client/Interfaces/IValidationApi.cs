...
namespace SFA.DAS.Commitments.Api.Client.Interfaces
{
    public interface IValidationApi
    {
        ...
        Task<IEnumerable<ApprenticeshipEmailOverlapValidationResult>> ValidateEmailOverlapping(IEnumerable<ApprenticeshipEmailOverlapValidationRequest> apprenticeshipOverlapValidation);
    }
}
