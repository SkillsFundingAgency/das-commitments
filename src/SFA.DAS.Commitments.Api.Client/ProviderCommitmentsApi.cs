...
{
    public class ProviderCommitmentsApi : IProviderCommitmentsApi
    {
        ...
        public ProviderCommitmentsApi(ICommitmentsApiClientConfiguration configuration, IHttpCommitmentHelper commitmentHelper)
        {
            _configuration = configuration;
        ...
        {
            var url = $"{BaseUrl}api/provider/{providerId}/commitments/{commitmentId}";
        ...
        {
            var url = $"{BaseUrl}api/provider/{providerId}/apprenticeships/";
        ...
        {
            var url = $"{BaseUrl}api/provider/{providerId}/apprenticeships/{apprenticeshipId}";
        ...
        {
            var url = $"{BaseUrl}api/provider/{providerId}/commitments/{commitmentId}/apprenticeships";
        ...
        {
            var url = $"{BaseUrl}api/provider/{providerId}/commitments/{commitmentId}/apprenticeships/{apprenticeshipId}";
        ...
        {
            var url = $"{BaseUrl}api/provider/{providerId}/commitments";
        ...
        {
            var url = $"{BaseUrl}api/provider/{providerId}/commitments/{commitmentId}/apprenticeships/bulk";
        ...
        {
            var url = $"{BaseUrl}api/provider/{providerId}/apprenticeships/{apprenticeshipId}/update";
