...
{
    [TestFixture]
    public class WhenGettingAnApprovedApprenticeship : EmployerOrchestratorTestBase
    {
        ...
        [Test]
        public async Task ThenTheCallerIsTheEmployer()
        {
            //Act
            await Orchestrator.GetApprovedApprenticeship(1, 2);
            ...
            MockMediator.Verify(x =>
                x.SendAsync(It.Is<GetApprovedApprenticeshipRequest>(r =>
                    r.Caller.CallerType == CallerType.Employer && r.Caller.Id == 1)));
        }
    }
}
