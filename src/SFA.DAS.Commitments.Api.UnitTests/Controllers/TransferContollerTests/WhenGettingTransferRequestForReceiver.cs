...
{
    [TestFixture]
    public class WhenGettingTransferRequestForReceiver
    {
        ...
        {
            await _sut.GetTransferRequestForReceiver(111, 222);

            _mockEmployerOrchestrator.Verify(x => x.GetTransferRequest(222, 111, CallerType.TransferReceiver));
        }
