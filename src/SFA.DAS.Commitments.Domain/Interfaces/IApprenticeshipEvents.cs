...
namespace SFA.DAS.Commitments.Domain.Interfaces
{
    public interface IApprenticeshipEvents
    {
        ...
        Task PublishEvent(Commitment commitment, Apprenticeship apprenticeship, string v1, DateTime? effectiveFrom, DateTime? effectiveTo);
        ...
        Task PublishChangeApprenticeshipStatusEvent(Commitment commitment, Apprenticeship apprenticeship, PaymentStatus paymentStatus, DateTime? effectiveFrom = null, DateTime? effectiveTo = null);
    }
}
