...
using SFA.DAS.Tasks.Infrastructure.Data;
...
namespace SFA.DAS.Tasks.Api.DependencyResolution {
    ...
    public class DefaultRegistry : Registry {
        ...
        public DefaultRegistry()
        {
            ...
            For<ITaskRepository>().Use<TaskRepository>().Ctor<TaskConfiguration>().Is(config);
        }
        ...
        private TaskConfiguration GetConfiguration()
        {
            ...
            return configurationService.Get<TaskConfiguration>();
        }
