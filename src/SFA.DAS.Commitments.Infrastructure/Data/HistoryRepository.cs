...
namespace SFA.DAS.Commitments.Infrastructure.Data
{
    public class HistoryRepository : BaseRepository, IHistoryRepository
    {
        ...
        public async Task InsertHistory(IEnumerable<HistoryItem> historyItems)
        {
            ...
            {
                await InsertHistory(connection, transaction, historyItems);
            });
        }

        public async Task InsertHistory(IDbConnection connection, IDbTransaction transaction, IEnumerable<HistoryItem> historyItems)
        {
