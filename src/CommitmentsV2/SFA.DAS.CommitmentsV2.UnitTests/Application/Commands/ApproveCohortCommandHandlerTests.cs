...
namespace SFA.DAS.CommitmentsV2.UnitTests.Application.Commands
{
    ...
    public class ApproveCohortCommandHandlerTests
    {
        ...
        public async Task Handle_WhenHandlingCommand_ThenShouldApproveCohort()
        {
            ...
            fixture.CohortDomainService.Verify(s => s.ApproveCohort(fixture.Command.CohortId, fixture.Command.Message, fixture.Command.UserInfo, fixture.Command.Party, fixture.CancellationToken));
        }
    }
