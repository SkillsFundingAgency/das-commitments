    ...
    public class CohortDomainServiceTests
    {
        ...
        public class CohortDomainServiceTestFixture
        {
            ...
            public CohortDomainServiceTestFixture()
            {
                ...
                OverlapCheckService.Setup(x => x.CheckForOverlaps(It.IsAny<string>(), It.IsAny<DateRange>(),
            ...
            public CohortDomainServiceTestFixture WithUlnOverlapOnStartDate()
            {
                ...
                OverlapCheckService.Setup(x => x.CheckForOverlaps(It.Is<string>(uln => uln == "X"),
                        It.IsAny<DateRange>(), It.IsAny<long?>(), It.IsAny<CancellationToken>()))
