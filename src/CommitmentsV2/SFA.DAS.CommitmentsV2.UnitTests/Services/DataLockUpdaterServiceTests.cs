...
public class DataLockUpdaterServiceTests
{
    ...
    public void Arrange()
    {
        ...
        SeedApprenticeshipUpdate(SeedApprenticeships[0].Id, SeedApprenticeships[0]);
        SeedDataLock(SeedApprenticeships[0], 1, 1, "25-6-01/06/2016", DateTime.Now, DataLockErrorCode.Dlock03);
        SeedLastEventId(1);
    ...
    public async Task ThenTheLastDataLockEventIdAndAPageOfDatalockIsRetrieved()
    {
        ...
        SeedDataLock(SeedApprenticeships[0], dataLockStatusId, maxDataLockEventId, priceEpisode, DateTime.Now, DataLockErrorCode.Dlock03);
    ...
    public async Task ThenInsertDataLockStatusRecordsIfNoDataLockExist()
    {
        ...
        SeedDataLock(SeedApprenticeships.FirstOrDefault(),
            dataLockEventId2, dataLockEventId2, "TEST-15/08/2018", DateTime.Now, DataLockErrorCode.Dlock07, true);

        SeedDataLock(SeedApprenticeships.FirstOrDefault(),
            dataLockEventId3, dataLockEventId3, "TEST-15/08/2019", DateTime.Now, DataLockErrorCode.Dlock07, true);

        SeedDataLock(SeedApprenticeships.FirstOrDefault(),
            dataLockEventId4, dataLockEventId4, "TEST-15/08/2020", DateTime.Now, DataLockErrorCode.Dlock03, true);
    ...
    public async Task ThenUpdateDataLockStatusRecordToResolved()
    {
        ...
        SeedDataLock(SeedApprenticeships.FirstOrDefault(),
            dataLockEventId2, dataLockEventId2, "TEST-15/08/2018", DateTime.Now, DataLockErrorCode.Dlock07, dataLockResolved);

        SeedDataLock(SeedApprenticeships.FirstOrDefault(),
            dataLockEventId3, dataLockEventId3, "TEST-15/08/2019", DateTime.Now, DataLockErrorCode.Dlock07, dataLockResolved);

        SeedDataLock(SeedApprenticeships.FirstOrDefault(),
            dataLockEventId4, dataLockEventId4, "TEST-15/08/2020", DateTime.Now, DataLockErrorCode.Dlock03, dataLockResolved);
    ...
    public async Task AndDataLockPageContainsDataLockSuccessThenDataLockFlagHasBeenUpdatedForTheApprenticeship()
    {
        ...
        SeedApprenticeshipUpdate(SeedApprenticeships[1].Id, SeedApprenticeships[1]);
        SeedDataLock(SeedApprenticeships[1], 1, 1, "TEST-15/08/2018", new DateTime(2018, 8, 1), DataLockErrorCode.None);
        ...
        SeedApprenticeshipUpdate(SeedApprenticeships[2].Id, SeedApprenticeships[2]);
        SeedDataLock(SeedApprenticeships[2], 2, 2, "TEST-15/08/2018", new DateTime(2018, 8, 1), DataLockErrorCode.None);
        SeedLastEventId(2);
        SeedData(Db);
    ...
    public async Task ThenPendingChangesAreExpiredOnSuccessfulDatalock(long objectId, DataLockErrorCode errorCode, bool expectExpiry)
    {
        ...
        SeedApprenticeshipUpdate(objectId, SeedApprenticeships.First(), ApprenticeshipUpdateStatus.Pending);
        SeedDataLock(SeedApprenticeships.First(), objectId, objectId, "TEST-15/08/2018", new DateTime(2018, 8, 1), errorCode);
    ...
    public async Task ThenPendingChangesWithoutCourseOrPriceAreNotExpiredOnSuccessfulDatalock(long objectId, DataLockErrorCode errorCode)
    {
        ...
        SeedApprenticeshipUpdate(objectId, SeedApprenticeships.First());
        ...
        SeedDataLock(SeedApprenticeships.First(), objectId, objectId, "TEST-15/08/2018", DateTime.Now, errorCode);
        ...
        //Assert
        var apprenticeship = Db.Apprenticeships.First(x => x.Id == objectId);
        Assert.That(apprenticeship.PendingUpdateOriginator, Is.EqualTo(Originator.Unknown));

        var apprenticeshipUpdate = Db.ApprenticeshipUpdates.First(x => x.Id == objectId);
        Assert.That(apprenticeshipUpdate.Status, Is.EqualTo(ApprenticeshipUpdateStatus.Pending));
    }
    ...
    public async Task ThenDatalocksForStoppedAndBackdatedApprenticeshipsAreAutoResolved()
    {
        ...
        SeedDataLock(SeedApprenticeships[0],
            ...
            DateTime.Now,
            DataLockErrorCode.Dlock07, dataLockResolved);
    ...
    public async Task ThenPriceDatalocksInCombinationWithDlock09AreIgnored()
    {
        ...
        SeedApprenticeshipUpdate(SeedApprenticeships.First().Id, SeedApprenticeships.First());
        SeedData(Db);
    ...
    private void SeedApprenticeship(long apprenticeshipId,
    ...
    private void SeedApprenticeshipUpdate(
    ...
    private void SeedLastEventId(long? id)
    {
