...
namespace SFA.DAS.CommitmentsV2.UnitTests.Validators
{
    ...
    public class CreateCohortRequestValidatorTests
    {
        ...
        private void AssertValidationResult<T>(Expression<Func<CreateCohortRequest, T>> property, T value,
            bool expectedValid)
        {
            // Arrange
        ...
        private void AssertValidationResult<T>(Expression<Func<CreateCohortRequest, T>> property,
