...
namespace SFA.DAS.CommitmentsV2.UnitTests.Mapping
{
    ...
    public class AddDraftApprenticeshipRequestToAddDraftApprenticeshipCommandMapperTests
    {
        ...
        private void AssertPropertySet(Action<AddDraftApprenticeshipRequest> setInput, Func<AddDraftApprenticeshipCommand, bool> expectOutput)
        {
            var mapper = new AddDraftApprenticeshipRequestToAddDraftApprenticeshipCommandMapper();

            var input = new AddDraftApprenticeshipRequest();
