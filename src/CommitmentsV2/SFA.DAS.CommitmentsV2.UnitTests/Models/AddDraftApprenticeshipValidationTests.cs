...
namespace SFA.DAS.CommitmentsV2.UnitTests.Models
{
    ...
    public class AddDraftApprenticeshipValidationTests
    {
            ...
            string expectedErrorMessage)
        {
            _fixture.DraftApprenticeshipDetails = new DraftApprenticeshipDetails
            {
                ...
                TrainingProgramme = new TrainingProgramme("TEST", "TEST", ProgrammeType.Framework,
                    courseEffectiveFromDate, courseEffectiveFromDate.AddYears(1))
            };

            var domainException = Assert.Throws<DomainException>(() =>
                _fixture.Cohort.AddDraftApprenticeship(_fixture.DraftApprenticeshipDetails, Party.Provider,
                    _fixture.UserInfo));
        ...
        public void Party_CheckValidation(EditStatus editStatus, Party modifyingParty)
        {
            ...
            var domainException = Assert.Throws<DomainException>(() =>
                _fixture.Cohort.AddDraftApprenticeship(_fixture.DraftApprenticeshipDetails, modifyingParty,
                    _fixture.UserInfo));
            var domainError =
                domainException.DomainErrors.SingleOrDefault(e => e.PropertyName == nameof(modifyingParty));
    ...
    public class AddDraftApprenticeshipValidationTestsFixture
    {
        ...
        public AddDraftApprenticeshipValidationTestsFixture WithTrainingProgrammeEffectiveBetween(DateTime startDate,
            DateTime endDate)
        {
