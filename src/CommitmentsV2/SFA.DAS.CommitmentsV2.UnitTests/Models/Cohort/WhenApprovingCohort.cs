...
public class WhenApprovingCohort
{
    ...
    {
        const Party modifyingParty = Party.Provider;
    ...
    public void ThenIfTheDraftApprenticeshipIsCompleteWithOrWithoutContinuationId(Party modifyingParty, bool isMissingEmail, long? continuationOfId, bool isApproved)
    {
        _fixture
            .SetChangeOfPartyRequestId()
            .SetModifyingParty(modifyingParty)
