...
namespace SFA.DAS.CommitmentsV2.MessageHandlers.UnitTests.EventHandlers
{
    ...
    public class ApprenticeshipStoppedEventHandlerTests
    {
        ...
        private class ApprenticeshipStopDateChangedEventHandlerTestsFixture
        {
            ...
            {
                _resolveOverlappingTrainingDateRequestService.Verify(x => x.Resolve(_apprenticeshipStoppedEvent.ApprenticeshipId, Types.OverlappingTrainingDateRequestResolutionType.ApprenticeshipStopped), Times.Once);
            }
        }
    }
}
