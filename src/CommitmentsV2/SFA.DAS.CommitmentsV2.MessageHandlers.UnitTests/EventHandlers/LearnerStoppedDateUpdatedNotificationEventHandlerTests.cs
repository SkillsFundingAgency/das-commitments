...
[TestFixture]
public class LearnerWithdrawalNotificationEventHandlerTests
{
    public LearnerWithdrawalNotificationEventHandlerTestsFixture _fixture;

    [SetUp]
    public void Arrange()
    {
        _fixture = new LearnerWithdrawalNotificationEventHandlerTestsFixture();
    }
    ...
    public class LearnerWithdrawalNotificationEventHandlerTestsFixture
    {
        ...
        public LearnerWithdrawalNotificationEventHandlerTestsFixture()
        {
