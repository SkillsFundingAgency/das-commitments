...
namespace SFA.DAS.CommitmentsV2.MessageHandlers.UnitTests.EventHandlers.OverlappingTrainingDateRequest
{
    ...
    internal class DraftApprenticeshipUpdatedEventHandlerTests
    {
        ...
        private class DraftApprenticeshipUpdatedEventHandlerTestsFixture
        {
            ...
            {
                _resolveOverlappingTrainingDateRequestService.Verify(x => x.ResolveByDraftApprenticeshp(_draftApprenticeshipUpdatedEvent.DraftApprenticeshipId, Types.OverlappingTrainingDateRequestResolutionType.DraftApprenticeshipUpdated), Times.Once);
            }
        }
    }
}
