...
namespace SFA.DAS.CommitmentsV2.MessageHandlers.UnitTests.EventHandlers.OverlappingTrainingDateRequest
{
    ...
    class OverlappingTrainingDateForStoppedApprenticeshipEventHandlerTests
    {
        ...
        [Test]
        public async Task WhenHandlingOverlappingTrainingDateEvent_If_ApprenticeshipStatus_Is_Stopped_ThenSendEmailToEmployerIsCalled()
        {
            _fixture.WithApprenticeshipStatus(ApprenticeshipStatus.Stopped);

            await _fixture.Handle();

            _fixture.MessageHandlerContext.Verify(m => m.Send(It.Is<SendEmailToEmployerCommand>(c =>
                    c.Template == "OverlappingTrainingDateForStoppedApprenticeship" &&
                    c.NameToken == "Name" &&
                    ...
                    c.Tokens["StopDate"] == _fixture.StopDate.ToString("dd/MM/yyyy") &&
        ...
        public async Task WhenHandlingOverlappingTrainingDateEvent_If_ApprenticeshipStatus_Is_Not_Stopped_ThenSendEmailToEmployerIsNotCalled(ApprenticeshipStatus apprenticeshipStatus)
        {
    ...
    public class OverlappingTrainingDateForStoppedApprenticeshipEventHandlerFixture : EventHandlerTestsFixture<OverlappingTrainingDateEvent, OverlappingTrainingDateForStoppedApprenticeshipEventHandler>
    {
        ...
        public OverlappingTrainingDateForStoppedApprenticeshipEventHandlerFixture() : base((m) => null)
        {
            ...
            _apprenticeship.SetValue(x => x.ApprenticeshipStatus, ApprenticeshipStatus.Stopped);
        ...
        public OverlappingTrainingDateForStoppedApprenticeshipEventHandlerFixture WithApprenticeshipStatus(ApprenticeshipStatus apprenticeshipStatus)
        {
