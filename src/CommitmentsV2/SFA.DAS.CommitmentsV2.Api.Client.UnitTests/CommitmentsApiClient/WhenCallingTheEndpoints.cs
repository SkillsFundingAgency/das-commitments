...
namespace SFA.DAS.CommitmentsV2.Api.Client.UnitTests.CommitmentsApiClient
{
    ...
    public class WhenCallingTheEndpoints
    {
        ...
        public async Task GetLegalEntity_VerifyUrlAndDataIsCorrectPassedIn()
        {
            ...
            _fixture.MockRestHttpClient.Verify(x =>
                x.Get<AccountLegalEntityResponse>("api/accountlegalentity/123", null, CancellationToken.None));
        }
        ...
        public async Task GetCohort_VerifyUrlAndDataIsCorrectPassedIn()
        {
            ...
            _fixture.MockRestHttpClient.Verify(x =>
                x.Get<GetCohortResponse>("api/cohorts/123", null, CancellationToken.None));
        }
        ...
        public async Task GetDraftApprenticeship_VerifyUrlAndDataIsCorrectPassedIn()
        {
            ...
            _fixture.MockRestHttpClient.Verify(x =>
                x.Get<GetDraftApprenticeshipResponse>("api/cohorts/123/draft-apprenticeships/456", null,
        ...
        public async Task CreateCohort_VerifyUrlAndDataIsCorrectPassedIn()
        {
            ...
            _fixture.MockRestHttpClient.Verify(x =>
                x.PostAsJson<CreateCohortRequest, CreateCohortResponse>("api/cohorts", _fixture.CreateCohortRequest,
                    CancellationToken.None));
        }
        ...
        public async Task UpdateDraftApprenticeship_VerifyUrlAndDataIsCorrectPassedIn()
        {
            ...
            await _fixture.CommitmentsApiClient.UpdateDraftApprenticeship(cohortId, apprenticeshipId,
                _fixture.UpdateDraftApprenticeshipRequest, CancellationToken.None);
            _fixture.MockRestHttpClient.Verify(x =>
                x.PutAsJson($"api/cohorts/{cohortId}/draft-apprenticeships/{apprenticeshipId}",
                    _fixture.UpdateDraftApprenticeshipRequest, CancellationToken.None));
        }
        ...
        {
            await _fixture.CommitmentsApiClient.AddDraftApprenticeship(_fixture.CohortId,
                _fixture.AddDraftApprenticeshipRequest, CancellationToken.None);
            _fixture.MockRestHttpClient.Verify(x =>
                x.PostAsJson<AddDraftApprenticeshipRequest>($"api/cohorts/{_fixture.CohortId}/draft-apprenticeships",
                    _fixture.AddDraftApprenticeshipRequest, CancellationToken.None));
        }
    }
    ...
    public class WhenCallingTheEndpointsFixture
    {
        ...
        public WhenCallingTheEndpointsFixture SetupResponseForCreateCohort()
        {
            MockRestHttpClient.Setup(x =>
                    x.PostAsJson<CreateCohortRequest, CreateCohortResponse>(It.IsAny<string>(),
                        It.IsAny<CreateCohortRequest>(), CancellationToken.None))
        ...
        {
            MockRestHttpClient.Setup(x =>
                    x.PostAsJson(It.IsAny<string>(), It.IsAny<AddDraftApprenticeshipRequest>(), CancellationToken.None))
                .ReturnsAsync("");
            return this;
        }
    }
