...
namespace SFA.DAS.CommitmentsV2.Api.Client.UnitTests.Http
{
    ...
    public class RestClientTests : FluentTest<RestClientTestsFixture>
    {
        ...
        {
            return TestAsync(f => f.SetupHttpClientGetToReturnSuccessWithStringResponseBody(), f => f.CallGet(null), 
                (f, r) =>
                {
                    r.Should().NotBeNull();
        ...
        {
            return TestAsync(f => f.SetupHttpClientGetToReturnSuccessWithJsonObjectInResponseBody(), f => f.CallGetObject(null),
                (f, r) =>
                {
                    r.Should().NotBeNull();
        ...
        {
            return TestAsync(f => f.SetupHttpClientGetToReturnSuccessWithStringResponseBody(),
