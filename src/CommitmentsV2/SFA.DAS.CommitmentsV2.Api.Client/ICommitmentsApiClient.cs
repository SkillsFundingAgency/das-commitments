...
namespace SFA.DAS.CommitmentsV2.Api.Client
{
    public interface ICommitmentsApiClient
    {
        ...
        Task<IEnumerable<ApprenticeshipDetails>> GetApprenticeships(uint providerId, string sortField="", bool reverseSort = false, bool isDownload = false, CancellationToken cancellationToken = default);
