...
public partial class BulkUploadValidateCommandHandler
{
    ...
    private EmailOverlapCheckResult OverlapCheckEmail(BulkUploadAddDraftApprenticeshipRequest csvRecord)
    {
        ...
        {
            return overlapService.CheckForEmailOverlaps(csvRecord.Email, new CourseDateRange(learnerStartDate.Value, learnerEndDate.Value), null, null, CancellationToken.None).Result;
        }
