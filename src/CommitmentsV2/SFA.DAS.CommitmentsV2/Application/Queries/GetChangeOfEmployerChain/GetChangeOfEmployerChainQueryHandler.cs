...
public class GetChangeOfEmployerChainQueryHandler(Lazy<ProviderCommitmentsDbContext> dbContext) : IRequestHandler<GetChangeOfEmployerChainQuery, GetChangeOfEmployerChainQueryResult>
{
