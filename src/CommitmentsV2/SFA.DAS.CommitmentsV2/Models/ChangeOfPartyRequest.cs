...
namespace SFA.DAS.CommitmentsV2.Models
{
    public class ChangeOfPartyRequest : Aggregate, ITrackableEntity
    {
            ...
            DateTime now)
        {
            ...
            CheckPrice(changeOfPartyType, price);
        ...
        private void CheckPrice(ChangeOfPartyRequestType changeOfPartyType, int? price)
        {
            if (changeOfPartyType == ChangeOfPartyRequestType.ChangeProvider) return;
