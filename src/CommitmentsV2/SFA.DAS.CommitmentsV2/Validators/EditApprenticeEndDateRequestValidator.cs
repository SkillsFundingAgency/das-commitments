...
{
    public class EditApprenticeEndDateRequestValidator : AbstractValidator<UpdateEndDateOfCompletedRecordRequest>
    {
        public EditApprenticeEndDateRequestValidator()
        {
