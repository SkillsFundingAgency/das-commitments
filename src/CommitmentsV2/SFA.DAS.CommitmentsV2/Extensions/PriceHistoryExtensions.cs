...
namespace SFA.DAS.CommitmentsV2.Extensions
{
    ...
    {
        public static decimal GetPrice(this IEnumerable<PriceHistory> priceEpisodes, DateTime effectiveDate, long apprenticeshipId, ILogger<ApprenticeshipToApprenticeshipDetailsMapper> logger)
        {
            try
            {
            ...
            {
                logger.LogError($"In exception {apprenticeshipId}:{exp.Message}" );
                throw;
            }
        }
    }
