...
namespace SFA.DAS.CommitmentsV2.Mapping
{
    public class ITrainingProgrammeToTrainingProgrammeMapper : IOldMapper<ITrainingProgramme, TrainingProgramme>
    {
        ...
        private static ProgrammeType MapProgrammeTypesToV2ProgrammeTypes(DAS.Apprenticeships.Api.Types.ProgrammeType programmeType)
        {
            switch (programmeType)
            {
                case DAS.Apprenticeships.Api.Types.ProgrammeType.Framework:
                    return ProgrammeType.Framework;
                case DAS.Apprenticeships.Api.Types.ProgrammeType.Standard:
