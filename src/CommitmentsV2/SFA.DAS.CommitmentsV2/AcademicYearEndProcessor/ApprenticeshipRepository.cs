...
namespace SFA.DAS.CommitmentsV2.Infrastructure.Data
{
    public class ApprenticeshipRepository : BaseRepository, IApprenticeshipRepository
    {
        ...
        //public async Task UpdateApprenticeship(Apprenticeship_new apprenticeship, Caller caller)
        //{
        ...
        //public async Task<IList<Apprenticeship_new>> BulkUploadApprenticeships(long commitmentId, IEnumerable<Apprenticeship_new> apprenticeships)
        //{
        ...
        public async Task<Apprenticeship_new> GetApprenticeship(long apprenticeshipId)
        {
            return await WithConnection(async c =>
            {
                ...
                Apprenticeship_new result = null;

                await c.QueryAsync<Apprenticeship_new, PriceHistory, Apprenticeship_new>
        ...
        //         var apprenticeships = (await c.QueryAsync<Apprenticeship_new>(sql, parameters, commandType: CommandType.StoredProcedure))
        //             .ToList();
        ...
        //private static async Task<IList<Apprenticeship_new>> UploadApprenticeshipsAndGetIds(long commitmentId, SqlConnection x, DataTable table)
        //{
        //    IList<Apprenticeship_new> apprenticeships;
        ...
        //private DataRow AddApprenticeshipToTable(DataTable apprenticeshipsTable, long commitmentId, Apprenticeship_new a)
        //{
