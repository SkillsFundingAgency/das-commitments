...
namespace SFA.DAS.CommitmentsV2.Infrastructure.Data.Transactions
{
    public class ApprenticeshipUpdateTransactions : IApprenticeshipUpdateTransactions
    {
        ...
        public async Task<long> CreateApprenticeshipUpdate(IDbConnection connection, IDbTransaction trans, ApprenticeshipUpdate_new apprenticeshipUpdate)
        {
            ...
            parameters.Add("@CreatedOn", _currentDateTime.UtcNow);
        ...
        public async Task<long> UpdateApprenticeshipReferenceAndUln(IDbConnection connection, IDbTransaction trans, Apprenticeship_new apprenticeship)
        {
            var parameters = new DynamicParameters();
