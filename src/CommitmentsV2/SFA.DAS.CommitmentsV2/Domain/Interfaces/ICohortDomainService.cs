...
namespace SFA.DAS.CommitmentsV2.Domain.Interfaces
{
    ...
    {
        Task<DraftApprenticeship> AddDraftApprenticeship(long providerId, long cohortId, DraftApprenticeshipDetails draftApprenticeshipDetails, UserInfo userInfo, Party? requestingParty, LearnerVerificationResponse learnerVerificationResponse, CancellationToken cancellationToken);
        ...
        Task<Cohort> UpdateDraftApprenticeship(long cohortId, DraftApprenticeshipDetails draftApprenticeshipDetails, UserInfo userInfo, Party? requestingParty, LearnerVerificationResponse learnerVerificationResponse, CancellationToken cancellationToken);
