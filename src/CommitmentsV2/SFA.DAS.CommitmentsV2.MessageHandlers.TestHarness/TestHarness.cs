                ...
                try
                {
                    switch (key)
                    {
                        ...
                        case ConsoleKey.S:
                            ...
                            break;
                        case ConsoleKey.T:
                            await _publisher.Publish(new CohortWithChangeOfPartyCreatedEvent (10006, 1, Party.Provider, ChangeOfPartyRequestType.ChangeEmployer, "FirstName", "LastName", DateTime.UtcNow, new UserInfo()));
                            Console.WriteLine();
