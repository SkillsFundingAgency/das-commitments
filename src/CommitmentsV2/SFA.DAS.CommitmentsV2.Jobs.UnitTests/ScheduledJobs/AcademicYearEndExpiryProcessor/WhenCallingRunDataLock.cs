...
namespace SFA.DAS.CommitmentsV2.AcademicYearEndProcessor.UnitTests
{
    ...
    public class WhenCallingRunDataLock
    {
        ...
        private AcademicYearEndExpiryProcessor _academicYearEndProcessor;
        ...
        )
        {
            ...
            _logger.VerifyLogging($"{nameof(AcademicYearEndExpiryProcessor)} expired {testDatalockStatusItems.Count} items", LogLevel.Information, Times.Once);
